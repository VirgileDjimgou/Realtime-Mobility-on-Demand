    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                // sometimes  we have here  some issues because of not activated GPS Sensor on Smartphone  .....
        ...
        History = (FloatingActionButton) findViewById(R.id.material_design_floating_action_menu_item1);
        Rider_status = (FloatingActionButton) findViewById(R.id.material_design_floating_action_menu_item2);
        Settings = (FloatingActionButton) findViewById(R.id.material_design_floating_action_menu_item3);
        float_logout_disconnect = (FloatingActionButton) findViewById(R.id.material_design_floating_action_menu_item4);
