...
public class EmailLoginActivity_driver extends AppCompatActivity {
    private static String TAG = "EmailLoginActivity_driver";
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if (firstTimeAccess) {
                        ...
                        startActivity(new Intent(EmailLoginActivity_driver.this, DriverMapActivity.class));
                        ...
                        EmailLoginActivity_driver.this.finish();
                    }
                } else {
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, RegisterActivity_Drive.class), StaticConfig.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, RegisterActivity_Drive.class), StaticConfig.REQUEST_CODE_REGISTER);
        }
    }
    ...
    public void onBackPressed() {
        ...
        Intent MainAct = new Intent(EmailLoginActivity_driver.this, MainActivity_Driver.class);
    ...
    class AuthUtils {
        ...
        void createUser(final String First_Name , final String Last_Name , final String Phone_numb , final String Driver_Type , String email, String password) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(EmailLoginActivity_driver.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(EmailLoginActivity_driver.this) {
                                    @Override
                                ...
                                Toast.makeText(EmailLoginActivity_driver.this, "Register and Login success", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(EmailLoginActivity_driver.this, SplaschScreen.class));
                                EmailLoginActivity_driver.this.finish();
                            }
                        }
                    })
            ...
            try{
                FirebaseDatabase.getInstance().getReference().child("Driver/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        SharedPreferenceHelper.getInstance(EmailLoginActivity_driver.this).saveUserInfo(userInfo);
                    }
