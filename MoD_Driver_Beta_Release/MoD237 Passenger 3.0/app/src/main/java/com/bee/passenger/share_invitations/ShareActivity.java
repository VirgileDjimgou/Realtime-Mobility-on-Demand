...
package com.bee.passenger.share_invitations;
...
public class ShareActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set layout
        setContentView(R.layout.main_send_invitations);
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ShareActivity.this, ContactPickerActivity.class)
