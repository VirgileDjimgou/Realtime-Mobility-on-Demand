package com.gudana.mod.fragment;
...
import com.gudana.mod.MoD_PassengerMap_Activity;
import com.gudana.mod.airbnbmapexample.ui.activity.MovingMarkerActivity;
import com.gudana.mod.cardview.History_CardView;
import com.gudana.mod.data.FriendDB;
import com.gudana.mod.data.GroupDB;
import com.gudana.mod.fcm.CustomFcm_Util;
import com.gudana.mod.fcm.MainActivity_fcm;
        ...
        */
        ...
        DriverInfosDashbord.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                startActivity(new Intent(getActivity(), MoD_PassengerMap_Activity.class));
