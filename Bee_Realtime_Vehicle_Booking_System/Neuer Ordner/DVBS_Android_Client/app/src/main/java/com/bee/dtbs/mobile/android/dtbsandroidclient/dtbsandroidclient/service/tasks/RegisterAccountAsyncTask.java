...
public class RegisterAccountAsyncTask  extends AsyncTask<String,Void,Void> {
    ...
    protected void onPreExecute() {
        this.dialog.setMessage(this.activity.getString(com.bee.dtbs.mobile.android.dtbsandroidclient.R.string.pd_registering));
        this.dialog.show();
    }
    ...
    protected void onPostExecute(final Void result) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL,
                this.activity.getString(com.bee.dtbs.mobile.android.dtbsandroidclient.R.string.btn_ok), new DialogInterface.OnClickListener() {
