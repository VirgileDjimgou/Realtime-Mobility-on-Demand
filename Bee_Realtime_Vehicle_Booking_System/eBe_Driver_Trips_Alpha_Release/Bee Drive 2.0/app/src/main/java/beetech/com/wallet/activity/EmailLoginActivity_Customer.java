...
import beetech.com.wallet.ubersplash.MainActivity_Customer;


public class EmailLoginActivity_Customer extends AppCompatActivity {
    private static String TAG = "EmailLoginActivity_Customer";
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if (firstTimeAccess) {
                        ...
                        startActivity(new Intent(EmailLoginActivity_Customer.this, CustomerMapActivity_v2.class));
                        // startActivity(new Intent(EmailLoginActivity_Customer.this, MapsActivity.class));

                        // startActivity(new Intent(EmailLoginActivity_Customer.this, LocationsOverviewActivity.class));

                        EmailLoginActivity_Customer.this.finish();
                    }
                } else {
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, RegisterActivity_customer.class), StaticConfig.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, RegisterActivity_customer.class), StaticConfig.REQUEST_CODE_REGISTER);
        }
    }
    ...
    public void onBackPressed() {
        ...
        Intent MainAct = new Intent(EmailLoginActivity_Customer.this, MainActivity_Customer.class);
    ...
    class AuthUtils {
        ...
        void createUser(String email, String password) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(EmailLoginActivity_Customer.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(EmailLoginActivity_Customer.this) {
                                    @Override
                                ...
                                initNewUserInfo();
                                Toast.makeText(EmailLoginActivity_Customer.this, "Register and Login success", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(EmailLoginActivity_Customer.this, CustomerMapActivity_v2.class));
                                EmailLoginActivity_Customer.this.finish();
                            }
                        }
            ...
            try{
                FirebaseDatabase.getInstance().getReference().child("Driver/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        SharedPreferenceHelper.getInstance(EmailLoginActivity_Customer.this).saveUserInfo(userInfo);
                    }
