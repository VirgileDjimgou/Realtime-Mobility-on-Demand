...
import com.android.gudana.tindroid.media.SpanFormatter;
    ...
    public MessagesListAdapter(MessageActivity context, SwipeRefreshLayout refresher) {
        ...
        mSelectionModeCallback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                mActivity.getMenuInflater().inflate(R.menu.tin_menu_message_selected, menu);
                return true;
            }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEWTYPE_FULL_CENTER:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_meta_message, parent, false);
                bgColor = UiUtils.COLOR_META_BUBBLE;
                break;
            case VIEWTYPE_FULL_LEFT:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_left_single, parent, false);
                bgColor = UiUtils.COLOR_MESSAGE_BUBBLE;
                break;
            case VIEWTYPE_FULL_AVATAR:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_left_single_avatar, parent, false);
                bgColor = UiUtils.COLOR_MESSAGE_BUBBLE;
                break;
            case VIEWTYPE_FULL_RIGHT:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_right_single, parent, false);
                break;
            case VIEWTYPE_SIMPLE_LEFT:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_left, parent, false);
                bgColor = UiUtils.COLOR_MESSAGE_BUBBLE;
                break;
            case VIEWTYPE_SIMPLE_AVATAR:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_left_avatar, parent, false);
                bgColor = UiUtils.COLOR_MESSAGE_BUBBLE;
                break;
            case VIEWTYPE_SIMPLE_RIGHT:
                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tin_message_right, parent, false);
                break;
            default:
                return null;
        }
        ...
        try {
            ...
            if (val != null) {
                ...
                intent.setDataAndType(FileProvider.getUriForFile(mActivity,
                        "com.android.gudana.provider", file), mimeType);
