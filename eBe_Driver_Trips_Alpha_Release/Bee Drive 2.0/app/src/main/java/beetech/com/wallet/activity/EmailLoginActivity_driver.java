...
public class EmailLoginActivity_driver extends AppCompatActivity {
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            startActivityForResult(new Intent(this, RegisterActivity_Driver.class), StaticConfig.REQUEST_CODE_REGISTER, options.toBundle());
        } else {
            startActivityForResult(new Intent(this, RegisterActivity_Driver.class), StaticConfig.REQUEST_CODE_REGISTER);
        }
    }
