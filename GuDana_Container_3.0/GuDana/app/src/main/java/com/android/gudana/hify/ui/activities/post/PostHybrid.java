...
public class PostHybrid extends AppCompatActivity {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, PostHybrid.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hi_activity_post_hybrid);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("New Hybrid Post");

        try {
            getSupportActionBar().setTitle("New Hybrid Post");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_post:
                ...
                if (TextUtils.isEmpty(mEditText.getText().toString()) && !imagesList.isEmpty())
                    AnimationUtil.shakeView(mEditText, PostHybrid.this);
                else
                    uploadPost();
                        ...
                        mFirestore.collection("Posts")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        mDialog.dismiss();
                                        Toast.makeText(PostHybrid.this, "Post sent", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                })
