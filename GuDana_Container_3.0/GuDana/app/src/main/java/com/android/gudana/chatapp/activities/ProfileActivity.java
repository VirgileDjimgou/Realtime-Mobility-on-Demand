...
public class ProfileActivity extends AppCompatActivity
{
    ...
    public void initMyProfile()
    {
        ...
        button3.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                View mView = ProfileActivity.this.getLayoutInflater().inflate(R.layout.ca_status_dialog, null);
    ...
    public void initOtherProfile()
    {
        ...
        // Checking if current ca_user has sent or received a request from other ca_user
        ...
        requestsListener = new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                {
                    // Otherwise check if current ca_user has other ca_user as friend
