...
public class MainActivity_backup extends BaseActivity implements BottomNavigation.OnMenuItemSelectionListener {

    static final String TAG = MainActivity_backup.class.getSimpleName();
    ...
    private void selectItem(int position) {
        switch (position) {
            ...
            case 2: {
                ...
                startActivity(new Intent(MainActivity_backup.this, AssistantActivity.class));
                break;
            }
            case 3: {
        ...
        if (null != viewPager) {
            ...
            getBottomNavigation().setOnMenuChangedListener(new BottomNavigation.OnMenuChangedListener() {
                ...
                public void onMenuChanged(final BottomNavigation parent) {
                    ...
                    viewPager.setAdapter(new ViewPagerAdapter(MainActivity_backup.this, parent.getMenuItemCount()));
