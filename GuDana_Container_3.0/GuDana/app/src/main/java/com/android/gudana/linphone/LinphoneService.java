...
import com.android.gudana.linphone.ui.LinphoneOverlay;
...
//	private boolean mTestDelayElapsed; // add a timer for testing
	...
	*/
	...
	public void onCreate() {
		...
		// In case restart after a crash. Main in MainActivity_with_Drawer
...
//				}
		...
		// from killing us and keep the lin_audio quality high.
	...
	public void displayMessageNotification(String fromSipUri, String fromName, String message) {
		Intent notifIntent = new Intent(this, MainActivity_with_Drawer.class);
	...
	private Class<? extends Activity> incomingReceivedActivity = MainActivity_with_Drawer.class;
