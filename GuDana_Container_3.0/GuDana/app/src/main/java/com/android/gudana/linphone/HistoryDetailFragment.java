...
public class HistoryDetailFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.lin_history_detail, container, false);
	...
	public void onResume() {
		...
		if (MainActivity_with_Drawer.isInstanciated()) {
			// MainActivity_with_Drawer.instance().selectMenu(FragmentsAvailable.HISTORY_DETAIL);
	...
	public void onClick(View v) {
		...
		if (id == R.id.back) {
			...
			MainActivity_with_Drawer.instance().setAddresGoToDialerAndCall(sipUri, displayName, pictureUri == null ? null : Uri.parse(pictureUri));
		} else if (id == R.id.chat) {
			// MainActivity_with_Drawer.instance().displayChat(sipUri);
		}
	}
}
