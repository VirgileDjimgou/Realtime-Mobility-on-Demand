...
import com.android.rivchat.MainActivity_with_Drawer;
import com.android.rivchat.R;

import com.android.rivchat.linphone.LinphoneManager.AddressType;
import com.android.rivchat.linphone.assistant.AssistantActivity;
import com.android.rivchat.linphone.assistant.RemoteProvisioningLoginActivity;
...
import com.android.rivchat.linphone.purchase.InAppPurchaseActivity;
import com.android.rivchat.linphone.ui.AddressText;
import com.android.rivchat.linphone.xmlrpc.XmlRpcHelper;
import com.android.rivchat.linphone.xmlrpc.XmlRpcListenerBase;
...
public class LinphoneActivity extends Activity implements OnClickListener, ContactPicked, ActivityCompat.OnRequestPermissionsResultCallback {
	...
	private ImageView menu , return_home;
	...
	private void changeCurrentFragment(FragmentsAvailable newFragmentType, Bundle extras, boolean withoutAnimation) {
		...
		case CHAT_LIST:
			...
			fragment  = new ChatFragment_init();
			break;
		case CHAT:
	...
	public void initSideMenu() {
		...
		return_home.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Intent phoneActivity = new Intent(LinphoneActivity.this, MainActivity_with_Drawer.class);
