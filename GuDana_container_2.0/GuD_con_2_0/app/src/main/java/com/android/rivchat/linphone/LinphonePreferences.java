...
import com.android.rivchat.linphone.purchase.Purchasable;
...
public class LinphonePreferences {
	...
	public int getCodecBitrateLimit() {
		return getConfig().getInt("lin_audio", "codec_bitrate_limit", 36);
	}

	public void setCodecBitrateLimit(int bitrate) {
		getConfig().setInt("lin_audio", "codec_bitrate_limit", bitrate);
	}
	...
	public String getXmlrpcUrl(){
		return getConfig().getString("lin_assistant", "xmlrpc_url", null);
	}

	public void setXmlrpcUrl(String url){
		getConfig().setString("lin_assistant", "xmlrpc_url", url);
	}
	...
	public String getActivityToLaunchOnIncomingReceived() {
		return getConfig().getString("app", "incoming_call_activity", "com.android.rivchat.linphone.LinphoneActivity");
	}
