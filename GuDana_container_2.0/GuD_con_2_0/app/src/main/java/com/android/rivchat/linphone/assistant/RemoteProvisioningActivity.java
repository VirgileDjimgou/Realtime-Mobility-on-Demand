...
import com.android.rivchat.linphone.LinphoneService;
...
public class RemoteProvisioningActivity extends Activity {
	...
	private void goToLinphoneActivity() {
		if (LinphoneService.isReady()) {
			LinphoneService.instance().setActivityToLaunchOnIncomingReceived("com.android.rivchat.linphone.LinphoneLauncherActivity");
