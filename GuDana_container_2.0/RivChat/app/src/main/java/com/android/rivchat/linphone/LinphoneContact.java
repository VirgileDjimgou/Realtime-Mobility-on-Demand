...
public class LinphoneContact implements Serializable, Comparable<LinphoneContact> {
	...
	private void updateFriend() {
		...
		if (!ContactsManager.getInstance().hasContactsAccess()) {
			// This refresh is only needed if app has no lin_contacts permission to refresh the list of LinphoneFriends.
			// Otherwise lin_contacts will be refreshed due to changes in native contact and the handler in ContactsManager
