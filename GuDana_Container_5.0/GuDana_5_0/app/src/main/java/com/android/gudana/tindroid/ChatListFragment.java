...
public class ChatListFragment extends ListFragment implements AbsListView.MultiChoiceModeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tin_fragment_chat_list, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstance) {
        ...
        mAdapter = ((MainActivity_GuDDana) getActivity()).getChatListAdapter();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_new_p2p_topic:
                ...
                ((MainActivity_GuDDana)getActivity()).selectTab(ContactsFragment.TAB_CONTACTS);
                return true;
            ...
            case R.id.action_add_by_id:
                ...
                builder
                        ...
                        .setView(R.layout.tin_dialog_add_by_id)
                        .setCancelable(true)
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        mode.getMenuInflater().inflate(R.menu.tin_menu_contacts_selected, menu);
        return true;
    }
