...
public class TopicInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tin_fragment_topic_info, container, false);
    }
    ...
    private void showEditTopicText() {
        ...
        final View editor = View.inflate(builder.getContext(), R.layout.tin_dialog_edit_group, null);
    ...
    private void showMemberAction(final String topicTitle, final String title, final String uid, final String mode) {
        ...
        final LinearLayout actions = (LinearLayout) View.inflate(activity, R.layout.tin_dialog_member_actions, null);
        actionBuilder
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        // inflater.inflate(R.menu.tin_menu_topic_info, menu);
