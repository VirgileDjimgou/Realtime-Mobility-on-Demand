...
import com.bee.passenger.historyRecyclerView.HistoryAdapter;
import com.bee.passenger.historyRecyclerView.HistoryObject;
...
public class HistoryFragment extends Fragment {
    ...
    private String customerOrDriver = "Driver";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBalance = rootView.findViewById(R.id.balance);

        mHistoryRecyclerView = (RecyclerView) rootView.findViewById(R.id.historyRecyclerView);
        ...
        // customerOrDriver = getActivity().getIntent().getExtras().getString("customerOrDriver");
