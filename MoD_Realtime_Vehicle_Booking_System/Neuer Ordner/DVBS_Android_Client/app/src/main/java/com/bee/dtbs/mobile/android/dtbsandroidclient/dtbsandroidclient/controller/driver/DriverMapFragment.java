...
import com.bee.dtbs.mobile.android.dtbsandroidclient.dtbsandroidclient.controller.driver.booking.state.OnDutyAvailableBookingStateFragment;
...
public class DriverMapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.fragment_driver_map, container, false);

        Intent gpsService = new Intent(getActivity(), GpsLocationListener.class);
        getActivity().startService(gpsService);

        mapView = (MapView) v.findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.driver_map);
    ...
    public void setBookingState(Fragment fragment){
        getFragmentManager().beginTransaction()
                .replace(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.content_driver_taxi_booking_state, fragment, "DriverMapFragment").commit();
    }
