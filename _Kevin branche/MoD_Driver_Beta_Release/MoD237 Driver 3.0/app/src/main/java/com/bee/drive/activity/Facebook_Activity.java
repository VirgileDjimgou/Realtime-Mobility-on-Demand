...
public class Facebook_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ValidateRegistration = (Button) findViewById(R.id.bt_go);

        ValidateRegistration.setOnClickListener(new View.OnClickListener() {
        ...
        PhoneNumber = (EditText) findViewById(R.id.et_password);
        Type_of_Driver = (Spinner) findViewById(R.id.spinner);
