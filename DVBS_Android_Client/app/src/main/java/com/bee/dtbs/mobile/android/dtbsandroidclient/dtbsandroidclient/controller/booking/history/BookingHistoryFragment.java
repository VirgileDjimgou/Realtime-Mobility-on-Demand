...
public class BookingHistoryFragment extends ListFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        getListView()
                .setEmptyView(getActivity()
                        .getLayoutInflater()
                        .inflate(com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.booking_history_list_empty_view, null, true));
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        getFragmentManager().beginTransaction()
                .replace(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.content_frame, bookingViewFragment, "BookingViewFragment").commit();
