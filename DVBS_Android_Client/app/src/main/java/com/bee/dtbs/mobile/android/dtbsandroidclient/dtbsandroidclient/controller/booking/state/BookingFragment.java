...
public class BookingFragment extends Fragment implements BookingState {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.fragment_booking, container, false);

        String pickupLocation = getArguments().getString(DtbsPreferences.DATA_PICKUP_LOCATION);

        this.txtPickupLocation = (AutoCompleteTextView)v.findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.txt_pickup_location);
        this.txtDestinationLocation = (AutoCompleteTextView)v.findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.txt_destination_location);
        this.spinnerPassengerCount = (Spinner) v.findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.spinner_number_passengers);
        this.btnBookRide = (Button)v.findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.btn_request_ride);

        this.txtDestinationLocation.setAdapter(new AutoCompleteBookingAdapter(getActivity(), com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.auto_complete_address_layout));

        this.txtPickupLocation.setText(pickupLocation);
        this.txtPickupLocation.setAdapter(new AutoCompleteBookingAdapter(getActivity(), com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.auto_complete_address_layout));

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(),
                com.bee.dtbs.mobile.android.dtbsandroidclient.R.array.spinner_number_passengers, android.R.layout.simple_spinner_dropdown_item);
    ...
    public void awaitTaxi(Booking booking) {
        ...
        fm.popBackStack();
        ft.replace(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.content_map_state_frame, f);
