            ...
            mFirestore.collection("Users")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            ...
                            your_name = documentSnapshot.getString("name");
                            your_image = documentSnapshot.getString("image");
                                            ...
                                            mFirestore.collection("Users")
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            final String name_c = documentSnapshot.getString("name");
                                                            final String email_c = documentSnapshot.getString("email");
                                                            final String id_c = documentSnapshot.getId();
                                                            final String image_c = documentSnapshot.getString("image");
