...
public class ForgottenPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.bee.dtbs.mobile.android.dtbsandroidclient.R.layout.activity_forgotten_password);
        Toolbar toolbar = (Toolbar) findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.toolbar);
        setSupportActionBar(toolbar);

        username = getIntent().getStringExtra("username");

        txtAccessCode = (EditText)findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.txt_access_code);
        txtNewPassword = (EditText)findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.txt_new_password);
        txtNewPassword2 = (EditText)findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.txt_new_password2);
        btnResetPassword = (Button)findViewById(com.bee.dtbs.mobile.android.dtbsandroidclient.R.id.btn_reset_password);
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!validateFields(getString(com.bee.dtbs.mobile.android.dtbsandroidclient.R.string.blank_field), txtAccessCode, txtNewPassword, txtNewPassword2)){
                    return;
                }

                if(!txtNewPassword.getText().toString().equals(txtNewPassword2.getText().toString())){
                    txtNewPassword.setError(getString(com.bee.dtbs.mobile.android.dtbsandroidclient.R.string.password_match));
                    txtNewPassword2.setError(getString(com.bee.dtbs.mobile.android.dtbsandroidclient.R.string.password_match));
                    return;
                }
