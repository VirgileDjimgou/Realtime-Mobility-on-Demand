package com.bee.drive.airbnbmapexample.ui.activity;
...
import com.bee.drive.airbnbmapexample.constants.NetworkConstants;
import com.bee.drive.airbnbmapexample.controller.BaseInterface;
import com.bee.drive.airbnbmapexample.model.AddressModel;
import com.bee.drive.airbnbmapexample.ui.adapter.MapAdapter;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_airbnb);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        /*if(id == R.id.action_home){
            Intent i=new Intent(MainActivityGpsControl.this,MainActivityGpsControl.class);
            startActivity(i);
            return true;
        }*/
