...
public class FriendsListeActivity extends AppCompatActivity{

    private String TAG = FriendsListeActivity.class.getName();
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        context = FriendsListeActivity.this.getApplicationContext();
        ...
        mAdapter = new PostsAdapter(mPostsList, context,FriendsListeActivity.this);
        ...
        mPostsRecyclerView.setLayoutManager(new LinearLayoutManager(FriendsListeActivity.this));
