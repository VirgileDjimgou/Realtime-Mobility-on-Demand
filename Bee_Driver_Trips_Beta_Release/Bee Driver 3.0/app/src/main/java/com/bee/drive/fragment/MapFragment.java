...
public class MapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_driver_map_origin, container, false);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("profileImageUrl")!=null){
                        // for getApplication to getActivity
    ...
    private void connectDriver(){
        ...
        Toast.makeText(getContext(), "Driver connected  .... " , Toast.LENGTH_LONG).show();
    }
    ...
    private void disconnectDriver(){
        ...
        Toast.makeText(getContext(), "Driver Disconnected .... " , Toast.LENGTH_LONG).show();
    }
