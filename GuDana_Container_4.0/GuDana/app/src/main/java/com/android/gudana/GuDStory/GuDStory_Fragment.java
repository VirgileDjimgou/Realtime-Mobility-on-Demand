package com.android.gudana.GuDStory;
...
import com.android.gudana.GuDFeed.AlbumsAdapter;
...
public class GuDStory_Fragment extends Fragment {

    private RecyclerView recyclerView;
    private com.android.gudana.GuDFeed.AlbumsAdapter adapter;
    private List<com.android.gudana.GuDFeed.CardCustom> albumList;
    private Context context;
    public static ViewPager mViewPager;
    private BoomMenuButton bmb ;

    public GuDStory_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        try{
            ...
            view_layout = inflater.inflate(R.layout.story_fragment_card_main, container, false);
                ...
                HamButton.Builder builder_0_doc = new HamButton.Builder()
                        ...
                        .listener(new OnBMClickListener() {
                            ...
                            public void onBoomButtonClick(int index) {
                                ...
                                Intent profileIntent = new Intent(GuDStory_Fragment.this.getContext(), create_post.class);
    ...
    private void prepareCards() {
        ...
        try{
            ...
            com.android.gudana.GuDFeed.CardCustom a = new com.android.gudana.GuDFeed.CardCustom("post 1", 24,covers[0]);
            albumList.add(a);

            a = new com.android.gudana.GuDFeed.CardCustom("post 2",  35,covers[1]);
            albumList.add(a);

            a = new com.android.gudana.GuDFeed.CardCustom("post 3", 44, covers[2]);
            albumList.add(a);
